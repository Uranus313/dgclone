...
import BestProductsDiscount from '../components/BestProducts/BestProductsDiscount'
  ...
  return (
    <main className='overflow-auto h-fit'>
      ...
      <div className='p5 my-5'>
        ...
        <div className='flex justify-center'>
          {categories.map((category) => (
            <Link href={`/products/${category.ID}`} className='mx-5' key={category.ID}>
              {(category?.Pictures?.length ?? 0) >0 &&<img width='100px' src={category.Pictures[1]} alt={category.Title} />}
      ...
      <div className='p5 mb-5 mt-14'>
        ...
        <BestProducts data={mostProducts.best_sales} />
      </div>
      ...
      <div className='p5 mb-5 mt-14'>
        ...
        <BestProductsDiscount data={mostProducts.best_discounts} />
      </div>
    </main>
  )
}
